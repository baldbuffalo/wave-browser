// Philips 55OLED804 (2019) – OLED, Android TV P, Ambilight 3-sided, RC-6

#include "../../model_registry.h"
#define RC6(cmd) ((uint32_t)((0<<16)|(0x00<<8)|(cmd)))

static const TVRemoteModel PHILIPS_55OLED804 = {
    .brand = "Philips", .model = "55OLED804", .year = 2019,
    ...
    .theme = { {0x1C,0x1C,0x1C,0xFF},{0x00,0x2B,0x8C,0xFF},{0x00,0x51,0xFF,0xFF},{0x2E,0x2E,0x2E,0xFF},{0xFF,0xFF,0xFF,0xFF} }
};
MODEL_REGISTER(PHILIPS_55OLED804)
