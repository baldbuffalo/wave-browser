// LG OLED55CX (2020) – OLED evo, WebOS 5, Alpha 9 Gen3

#include "../../model_registry.h"

static const TVRemoteModel LG_OLED55CX = {
    .brand = "LG", .model = "OLED55CX", .year = 2020,
    ...
    .theme = {
        {0x08,0x08,0x08,0xFF},{0xA5,0x00,0x64,0xFF},
        {0xFF,0x00,0x80,0xFF},{0x18,0x18,0x18,0xFF},{0xFF,0xFF,0xFF,0xFF}
    }
};
MODEL_REGISTER(LG_OLED55CX)
