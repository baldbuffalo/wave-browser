// Vizio M55-C2 (2015) – SmartCast, NEC protocol
// CEC Vendor ID: 0x0E5E5E (Vizio)

#include "../../model_registry.h"

#define VIZ(cmd) ((uint32_t)(0x20DF0000 | (uint8_t)(cmd) << 8 | (uint8_t)(~(cmd))))

static const TVRemoteModel VIZIO_M55C2 = {
    .brand = "Vizio", .model = "M55-C2", .year = 2015,
    .protocol = IRProtocol::NEC,
    .cec_vendor = 0x0E5E5E,
    .cec_osd_name_prefix = "VIZIO",
    .ir = {
        ...
        [TVBTN_RED]   = { 0,         0 }, [TVBTN_GREEN] = { 0,         0 },
        [TVBTN_YELLOW]= { 0,         0 }, [TVBTN_BLUE]  = { 0,         0 },
