// JVC LT-55MA877 (2018) – NEC protocol, addr 0xC5E8. CEC: 0x0054C3
#include "../../model_registry.h"
#define JVC_N(cmd) ((uint32_t)(0xC5E80000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel JVC_LT55MA877={
    .brand="JVC",.model="LT-55MA877",.year=2018,.protocol=IRProtocol::NEC,
