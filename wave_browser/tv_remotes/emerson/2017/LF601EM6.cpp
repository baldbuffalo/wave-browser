// Emerson LF601EM6 (2017) – NEC protocol
#include "../../model_registry.h"
#define EMR(cmd) ((uint32_t)(0x10EF0000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel EMERSON_LF601EM6={
    .brand="Emerson",.model="LF601EM6",.year=2017,.protocol=IRProtocol::NEC,
...
MODEL_REGISTER(EMERSON_LF601EM6)
