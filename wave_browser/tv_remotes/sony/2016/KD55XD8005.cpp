// Sony KD-55XD8005 (2016) – Android TV, SIRCS-20

#include "../../model_registry.h"

#define S20(ext, addr, cmd) ((uint32_t)(((ext)<<12)|((addr)<<7)|(cmd)))

static const TVRemoteModel SONY_KD55XD8005 = {
    .brand = "Sony", .model = "KD55XD8005", .year = 2016,
    ...
    .theme = {
        {0x1A,0x1A,0x1A,0xFF},{0x00,0x3C,0x8A,0xFF},
        {0x00,0x60,0xD0,0xFF},{0x2A,0x2A,0x2A,0xFF},{0xFF,0xFF,0xFF,0xFF}
    }
};
MODEL_REGISTER(SONY_KD55XD8005)
