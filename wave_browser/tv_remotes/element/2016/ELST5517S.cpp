// Element ELST5517S (2016) – NEC protocol
#include "../../model_registry.h"
#define ELM(cmd) ((uint32_t)(0xFF000000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel ELEMENT_ELST5517S={
    .brand="Element",.model="ELST5517S",.year=2016,.protocol=IRProtocol::NEC,
...
MODEL_REGISTER(ELEMENT_ELST5517S)
