// Magnavox 50MV314X (2015) – NEC protocol
#include "../../model_registry.h"
#define MAG(cmd) ((uint32_t)(0x17E80000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel MAGNAVOX_50MV314X={
    .brand="Magnavox",.model="50MV314X",.year=2015,.protocol=IRProtocol::NEC,
...
MODEL_REGISTER(MAGNAVOX_50MV314X)
