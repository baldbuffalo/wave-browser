// Toshiba 55L711U20 (2017) – NEC protocol, address 0x02FD
// CEC Vendor ID: 0x000039 (Toshiba)
#include "../../model_registry.h"
#define TOS(cmd) ((uint32_t)(0x02FD0000 | (uint8_t)(cmd) << 8 | (uint8_t)(~(cmd))))
static const TVRemoteModel TOSHIBA_55L711U20 = {
    .brand = "Toshiba", .model = "55L711U20", .year = 2017,
...
MODEL_REGISTER(TOSHIBA_55L711U20)
