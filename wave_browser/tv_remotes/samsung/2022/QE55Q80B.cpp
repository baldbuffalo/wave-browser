// Samsung QE55Q80B (2022) – Q80B QLED 4K, Neo series

#include "../../model_registry.h"

static const TVRemoteModel SAMSUNG_QE55Q80B = {
    .brand = "Samsung", .model = "QE55Q80B", .year = 2022,
    ...
    .theme = {
        {0x10,0x10,0x10,0xFF},{0x03,0x2C,0x6E,0xFF},
        {0x1A,0x73,0xE8,0xFF},{0x22,0x22,0x22,0xFF},{0xFF,0xFF,0xFF,0xFF}
    }
};
MODEL_REGISTER(SAMSUNG_QE55Q80B)
