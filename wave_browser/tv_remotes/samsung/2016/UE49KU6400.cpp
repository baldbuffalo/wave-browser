// Samsung UE49KU6400 (2016) – K-series 4K UHD Smart TV
// Smart Remote era: HOME code changed to 0xE0E09E61 → 0xE0E0FC03

#include "../../model_registry.h"

static const TVRemoteModel SAMSUNG_UE49KU6400 = {
    .brand            = "Samsung",
    .model            = "UE49KU6400",
    .year             = 2016,
    ...
    .ir = {
        ...
        [TVBTN_HOME]     = { 0xE0E0FC03, 0 },  // Smart Hub (KU series)
    ...
    .theme = {
        {0x1C,0x1C,0x1C,0xFF},{0x03,0x2C,0x6E,0xFF},
        {0x1A,0x73,0xE8,0xFF},{0x2D,0x2D,0x2D,0xFF},{0xFF,0xFF,0xFF,0xFF}
    }
};
MODEL_REGISTER(SAMSUNG_UE49KU6400)
