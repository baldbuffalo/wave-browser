// LG 43UH603V (2016) – WebOS 3, 4K UHD NEC IR

#include "../../model_registry.h"

static const TVRemoteModel LG_43UH603V = {
    .brand = "LG", .model = "43UH603V", .year = 2016,
    ...
    .theme = {
        {0x1A,0x1A,0x2A,0xFF},{0xA5,0x00,0x64,0xFF},
        {0xFF,0x00,0x80,0xFF},{0x2E,0x2E,0x3E,0xFF},{0xFF,0xFF,0xFF,0xFF}
    }
};
MODEL_REGISTER(LG_43UH603V)
