// Roku TCL-55P605-Roku (2017) – NEC protocol
#include "../../model_registry.h"
#define ROK(cmd) ((uint32_t)(0xFF000000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel ROKU_TCL_55P605_Roku={
    .brand="Roku",.model="TCL-55P605-Roku",.year=2017,.protocol=IRProtocol::NEC,
...
MODEL_REGISTER(ROKU_TCL_55P605_Roku)
