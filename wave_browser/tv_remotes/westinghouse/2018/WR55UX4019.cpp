// Westinghouse WR55UX4019 (2018) – NEC protocol
#include "../../model_registry.h"
#define WST(cmd) ((uint32_t)(0xFF000000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel WESTINGHOUSE_WR55UX4019={
    .brand="Westinghouse",.model="WR55UX4019",.year=2018,.protocol=IRProtocol::NEC,
...
MODEL_REGISTER(WESTINGHOUSE_WR55UX4019)
