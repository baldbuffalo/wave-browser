// Hisense 55U8G (2020) – ULED 4K Android TV
#include "../../model_registry.h"
#define HIS(cmd) ((uint32_t)(0x4000 << 16 | (uint8_t)(cmd) << 8 | (uint8_t)(~(cmd))))
static const TVRemoteModel HISENSE_55U8G = {
    .brand = "Hisense", .model = "55U8G", .year = 2020,
    ...
    .theme = { {0x14,0x14,0x14,0xFF},{0xE8,0x61,0x00,0xFF},{0xFF,0x90,0x20,0xFF},{0x22,0x22,0x22,0xFF},{0xFF,0xFF,0xFF,0xFF} }
};
MODEL_REGISTER(HISENSE_55U8G)
