// Hisense 55H8C (2016) – ULED 4K Android TV, NEC protocol
// CEC Vendor ID: 0x00E739 (Hisense)

#include "../../model_registry.h"
#define HIS(cmd) ((uint32_t)(0x4000 << 16 | (uint8_t)(cmd) << 8 | (uint8_t)(~(cmd))))

static const TVRemoteModel HISENSE_55H8C = {
    .brand = "Hisense", .model = "55H8C", .year = 2016,
    .protocol = IRProtocol::NEC,
    .cec_vendor = 0x00E739,
    .cec_osd_name_prefix = "Hisense",
    .ir = {
        ...
        [TVBTN_0] = {HIS(0x10),0}, [TVBTN_1] = {HIS(0x11),0},
        [TVBTN_2] = {HIS(0x12),0}, [TVBTN_3] = {HIS(0x13),0},
        [TVBTN_4] = {HIS(0x14),0}, [TVBTN_5] = {HIS(0x15),0},
        [TVBTN_6] = {HIS(0x16),0}, [TVBTN_7] = {HIS(0x17),0},
        [TVBTN_8] = {HIS(0x18),0}, [TVBTN_9] = {HIS(0x19),0},
