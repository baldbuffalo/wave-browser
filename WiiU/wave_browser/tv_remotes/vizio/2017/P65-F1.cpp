// Vizio P65-F1 (2017) – P-Series 4K HDR SmartCast
#include "../../model_registry.h"
#define VIZ(cmd) ((uint32_t)(0x20DF0000 | (uint8_t)(cmd) << 8 | (uint8_t)(~(cmd))))

static const TVRemoteModel VIZIO_P65F1 = {
    .brand = "Vizio", .model = "P65-F1", .year = 2017,
    .protocol = IRProtocol::NEC, .cec_vendor = 0x0E5E5E, .cec_osd_name_prefix = "VIZIO",
    .ir = {
        ...
        [TVBTN_0] = {VIZ(0x10),0}, [TVBTN_1] = {VIZ(0x01),0}, [TVBTN_2] = {VIZ(0x02),0},
        [TVBTN_3] = {VIZ(0x03),0}, [TVBTN_4] = {VIZ(0x04),0}, [TVBTN_5] = {VIZ(0x05),0},
        [TVBTN_6] = {VIZ(0x06),0}, [TVBTN_7] = {VIZ(0x07),0}, [TVBTN_8] = {VIZ(0x08),0},
        [TVBTN_9] = {VIZ(0x09),0},
    ...
    .theme = { {0x1A,0x1A,0x1A,0xFF},{0x00,0x61,0xAA,0xFF},{0x00,0x90,0xFF,0xFF},{0x2A,0x2A,0x2A,0xFF},{0xFF,0xFF,0xFF,0xFF} }
};
MODEL_REGISTER(VIZIO_P65F1)
