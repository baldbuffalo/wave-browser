// Sanyo DP55D44 (2013) – NEC protocol, addr 0xE0E0
#include "../../model_registry.h"
#define SAN(cmd) ((uint32_t)(0xE0E00000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel SANYO_DP55D44={
    .brand="Sanyo",.model="DP55D44",.year=2013,.protocol=IRProtocol::NEC,
