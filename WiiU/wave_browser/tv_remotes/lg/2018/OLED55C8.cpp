// LG OLED55C8 (2018) – OLED, WebOS 4, Alpha 7 processor

#include "../../model_registry.h"

static const TVRemoteModel LG_OLED55C8 = {
    .brand = "LG", .model = "OLED55C8", .year = 2018,
    .protocol = IRProtocol::NEC,
    .cec_vendor = 0x00E091, .cec_osd_name_prefix = "LG",
    .ir = {
        ...
        [TVBTN_0] = {0x20DF08F7,0}, [TVBTN_1] = {0x20DF8877,0},
        [TVBTN_2] = {0x20DF48B7,0}, [TVBTN_3] = {0x20DFC837,0},
        [TVBTN_4] = {0x20DF28D7,0}, [TVBTN_5] = {0x20DFA857,0},
        [TVBTN_6] = {0x20DF6897,0}, [TVBTN_7] = {0x20DFE817,0},
        [TVBTN_8] = {0x20DF18E7,0}, [TVBTN_9] = {0x20DF9867,0},
    ...
    .theme = {
        {0x0A,0x0A,0x0A,0xFF},{0xA5,0x00,0x64,0xFF},
        {0xFF,0x00,0x80,0xFF},{0x1E,0x1E,0x1E,0xFF},{0xFF,0xFF,0xFF,0xFF}
    }
};
MODEL_REGISTER(LG_OLED55C8)
