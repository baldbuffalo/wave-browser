// TCL 55C815 (2019) – QLED 4K Android TV, NEC IR

#include "../../model_registry.h"
#define TCL(cmd) ((uint32_t)(0xFF00 << 16 | (uint8_t)(cmd) << 8 | (uint8_t)(~(cmd))))

static const TVRemoteModel TCL_55C815 = {
    .brand = "TCL", .model = "55C815", .year = 2019,
    ...
    .theme = { {0x18,0x18,0x18,0xFF},{0xC0,0x1C,0x22,0xFF},{0xFF,0x40,0x40,0xFF},{0x28,0x28,0x28,0xFF},{0xFF,0xFF,0xFF,0xFF} }
};
MODEL_REGISTER(TCL_55C815)
