// Panasonic TX-55EX750 (2017) – 4K UHD HDR my Home Screen 2.0

#include "../../model_registry.h"
#define PAN(oem, cmd) ((uint32_t)(((uint32_t)(oem)<<16)|(cmd)))

static const TVRemoteModel PANASONIC_TX55EX750 = {
    .brand = "Panasonic", .model = "TX-55EX750", .year = 2017,
...
MODEL_REGISTER(PANASONIC_TX55EX750)
