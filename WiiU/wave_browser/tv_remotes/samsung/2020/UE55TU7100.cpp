// Samsung UE55TU7100 (2020) – Crystal UHD 4K

#include "../../model_registry.h"

static const TVRemoteModel SAMSUNG_UE55TU7100 = {
    .brand = "Samsung", .model = "UE55TU7100", .year = 2020,
...
MODEL_REGISTER(SAMSUNG_UE55TU7100)
