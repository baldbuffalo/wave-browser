// Samsung UN55KU6300 (2016) – US KU 4K series

#include "../../model_registry.h"

static const TVRemoteModel SAMSUNG_UN55KU6300 = {
    .brand = "Samsung", .model = "UN55KU6300", .year = 2016,
...
MODEL_REGISTER(SAMSUNG_UN55KU6300)
