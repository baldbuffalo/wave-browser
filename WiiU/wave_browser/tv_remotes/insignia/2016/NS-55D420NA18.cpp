// Insignia NS-55D420NA18 (2016) – NEC protocol
#include "../../model_registry.h"
#define INS(cmd) ((uint32_t)(0x20DF0000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel INSIGNIA_NS_55D420NA18={
    .brand="Insignia",.model="NS-55D420NA18",.year=2016,.protocol=IRProtocol::NEC,
...
MODEL_REGISTER(INSIGNIA_NS_55D420NA18)
