// Rca RNSMU5536 (2016) – NEC protocol
#include "../../model_registry.h"
#define RCA(cmd) ((uint32_t)(0xEE110000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel RCA_RNSMU5536={
    .brand="Rca",.model="RNSMU5536",.year=2016,.protocol=IRProtocol::NEC,
