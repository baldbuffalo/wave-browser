// Hitachi 58R80 (2018) – NEC protocol, addr 0x0E0E. CEC: 0x00A000
#include "../../model_registry.h"
#define HIT(cmd) ((uint32_t)(0x0E0E0000|(uint8_t)(cmd)<<8|(uint8_t)(~(cmd))))
static const TVRemoteModel HITACHI_58R80={
    .brand="Hitachi",.model="58R80",.year=2018,.protocol=IRProtocol::NEC,
